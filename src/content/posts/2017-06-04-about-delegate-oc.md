...
description: "前言 在 Objective C 项目中，不少开发者们可能会写或者曾看到过这样的代码： ？？把自己的代理设置为自己？？这种做法到底妥不妥呢？ 本文将采用自问自答、通俗易懂的方式讨论 self.delegate = self 这种做法是否妥当"
tags:
  - "iOS"
  - "Objective-C"
draft: false
legacySlug: "about-delegate-oc"
---
## 前言
...
![about-delegate-conditional-break](/assets/histories/blog/images/2017/about-delegate-conditional-breakpoint.png)
    
进入断点调试后，发现一个有意思的事，如图所示：

![about-delegate-infinite-exe-point](/assets/histories/blog/images/2017/about-delegate-infinite-exe-point.png)
...
![about-delegate-self-infinite](/assets/histories/blog/images/2017/about-delegate-self-infinite.png)
...
![about-delegate-message-forwarding](/assets/histories/blog/images/2017/about-delegate-message-forwarding.png)
