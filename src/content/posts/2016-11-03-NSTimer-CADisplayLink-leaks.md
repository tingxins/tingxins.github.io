...
description: "偶得前言 NSRunLoop与定时器 invalidate的作用 我们如何解决？ 偶得前言 本篇文章中我们主要谈谈 NSTimer \\\\ CADisplayLink 在使用过程中牵扯到内存泄漏的相关问题及解决思路（文章末尾会附上Demo），"
tags:
  - "iOS"
draft: false
legacySlug: "NSTimer-CADisplayLink-leaks"
---
- [偶得前言](#偶得前言)
