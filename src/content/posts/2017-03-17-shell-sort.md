...
description: "前言 希尔排序 算法其本质就是插入排序，是直接插入排序算法的一种改进，因 D.L shell 于 1959 年提出而得名，通常我们也称希尔排序为 缩小增量排序 ，所谓 增量 ，即将待排序的序列按该增量分割一个或多个子序列，所谓 缩小 ，即当"
tags:
  - "C"
  - "算法"
draft: false
legacySlug: "shell-sort"
---
