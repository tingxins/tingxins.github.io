...
description: "最近在看书的时候突然纠结于Unicode相关字符编码，查了一些资料，并写了这篇文章，顺带做下笔记，希望能帮到一些人。文章如果有写的不妥的或者不正确的地方还请大家纠正。 Unicode 编码 Unicode是一个符号集，它对世界上大部分的文字"
tags: []
draft: false
legacySlug: "character-encoding-01"
---
