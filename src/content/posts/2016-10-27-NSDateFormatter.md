...
description: "为什么要优化NSDateFormatter？ 优化方式有哪些？ 为什么要优化NSDateFormatter？ 首先，过度的创建 NSDateFormatter 用于 NSDate 与 NSString 之间转换，会导致App卡顿，打开Pro"
tags:
  - "iOS"
  - "Objective-C"
draft: false
legacySlug: "NSDateFormatter"
---
