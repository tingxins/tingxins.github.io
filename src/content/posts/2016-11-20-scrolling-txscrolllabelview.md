...
description: "前言 前段时间在开发一个广播的功能，网上也自己找了一些库，没有发现非常好用的，于是自己抽时间写了一个，发布一天收获六十多个 star ，这里首先感谢大家在微博上的转发，使得 TXScrollLabelView 被更多需要的人知道，同时非常感"
tags:
  - "iOS"
  - "开源项目"
draft: false
legacySlug: "scrolling-txscrolllabelview"
---
# 前言
