...
description: "前言 哥德巴赫猜想是 Goldbach's Conjecture 是数论中存在最久的未解问题之一，是一个伟大的世界性的数学猜想，其基本思想可以陈述为： 任何一个大于2的偶数，都能表示成两个素数之和。 如： 4 = 2 + 2 6 = 3 +"
tags:
  - "C"
  - "算法"
draft: false
legacySlug: "goldbach-conjecture"
---
...
![algorithm-analyze-a](/assets/images/2017/algorithm-analyze-a.png)

#### B 算法分析

![algorithm-analyze-b](/assets/images/2017/algorithm-analyze-b.png)
