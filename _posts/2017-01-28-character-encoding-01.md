...
Unicode 标量值 <br>（0x）  | UTF-8 <br>（0b） | 备注
------------ | ------------- | ------------
000000-00007F | 0xxxxxxx  | 与ASCII编码字符相对应，最高位恒为0 <br> 占用一个字节
000080-0007FF | 110xxxxx-10xxxxxx | 第一个字节由110开始，接着的字节由10开始 <br> 占用两个字节
000800-00D7FF | 1110xxxx-10xxxxxx-10xxxxxx | 占用3个字节
00D800-00DFFF | -  | D800-DBFF 代表 UTF-16的高半区 <br> DC00-DFFF 代表 UTF-16的低半区
00E000-00FFFF | 1110xxxx-10xxxxxx-10xxxxxx  | 占用3个字节
010000-10FFFF | 11110xxx-10xxxxxx-10xxxxxx-10xxxxxx  | 最高字节前1的数量代表字节数，如：1110即3个字节 <br> 占用4个字节
...
Unicode 标量值 <br>（0x）  | UTF-16 <br>（0b） | 备注
------------ | ------------- | ------------
